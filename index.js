...
console.log(createMenuItem('grilled-cheese',4,'breakfast'));
console.log(createMenuItem('pasta',11,'dinner'));
...
const reviews = [
    ...
    {name: "Wen", rating: 4.5, feedback:"I don't leave my house often, but when I do, it's for this place. Highly recomend."},
